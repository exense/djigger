...
public class SequenceTreeModel implements TreeModel {
	...
	public SequenceTreeModel(SequenceTreeNode root) {
		super();
		this.root = root;
	}
	...
	public Object getChild(Object _parent, int index) {
		SequenceTreeNode parent = (SequenceTreeNode) _parent;
	...
	public boolean isLeaf(Object _node) {
		SequenceTreeNode node = (SequenceTreeNode) _node;
		return node.isLeaf();
	}
	...
	public int getIndexOfChild(Object _parent, Object _child) {
		SequenceTreeNode parent = (SequenceTreeNode) _parent;
		SequenceTreeNode child = (SequenceTreeNode) _child;
