...
public class FilterExpressionLexer extends antlr.CharScanner implements FilterExpressionLexerTokenTypes, TokenStream
 {
public FilterExpressionLexer(InputStream in) {
	this(new ByteBuffer(in));
}
public FilterExpressionLexer(Reader in) {
	this(new CharBuffer(in));
}
public FilterExpressionLexer(InputBuffer ib) {
	this(new LexerSharedInputState(ib));
}
public FilterExpressionLexer(LexerSharedInputState state) {
	super(state);
