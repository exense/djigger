...
public class Collector {
	...
	public static void report(String classname, String method, long startTime, long durationNano, boolean[] attributes) {
		try {
			...
			buffer.put(new InstrumentationSample(classname, method, startTime, durationNano, attributesHolder));
		} catch (Exception e) {
